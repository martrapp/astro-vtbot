...
## Usage
Install astro-vtbot in your project with `npm install astro-vtbot` and insert the `<Linter/>` component near the `<ViewTransitions/>` component into the `<head>` of your page.
