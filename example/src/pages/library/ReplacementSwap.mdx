...
Install astro-vtbot to your project with `npm install astro-vtbot` and include the `<ReplacementSwap/>` component directly after the `<ViewTransitions/>` tag in your `<head>` page.
