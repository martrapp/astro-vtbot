...
This demo shows how you can effectively suppress scrolling when navigating to the next page. The
new page is displayed in the same scroll position as the page you left. This is useful for e.g.
product pages where you want to compare the products.
...
Mam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim
